...
const AnimatedIntroSection: React.FC = () => {
  ...
  return (
    <div 
      ref={rootRef}
      className="relative min-h-[30vh] md:min-h-[70vh] bg-blank-slate" // Added padding to account for navbar
    >
      <div className="slide-section w-full h-[30vh] md:h-full">
        <div className="absolute rounded-3xl inset-0 bg-founders-fire" />
        
        {/* Content */}
        <div className="relative z-40 min-h-[30vh] md:min-h-[70vh] flex items-center px-8">
