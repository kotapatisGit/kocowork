      ...
      <div className="w-[90vw] mx-auto bg-signal-blue rounded-3xl shadow-lg p-8 md:p-12">
        <div className="container mx-auto">
          ...
          <div className="flex items-center gap-3 mb-16">
            ...
            <h2 className="text-5xl font-bold text-blank-slate">About KOCOwork</h2>
          </div>

          {/* Hero Statement */}
          <div className="text-center max-w-5xl mx-auto mb-20">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold bg-blank-slate text-transparent bg-clip-text leading-tight mb-8">
