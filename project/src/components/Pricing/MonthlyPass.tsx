  ...
  return (
    <div className="bg-blank-slate flex flex-col rounded-xl overflow-hidden transition-all duration-300 hover:shadow-xl border border-gray-200 shadow-md h-full">
      <div className="p-6 flex flex-col flex-1">
        <h4 className="text-3xl font-bold text-focus-black mb-4 font-darker">Monthly Pass</h4>
        
        <div className="mb-6 flex items-baseline">
          <span className="text-[2.75rem] font-bold text-focus-black font-darker">₹9,999</span>
          <span className="text-focus-black ml-2 text-xl font-semibold">/month</span>
        </div>
        ...
        <a 
          ...
          onClick={(e) => {
            ...
            if (contactForm && planSelect) {
              ...
              const optionToSelect = options.find(option => option.text === 'Monthly Pass');
              if (optionToSelect) {
