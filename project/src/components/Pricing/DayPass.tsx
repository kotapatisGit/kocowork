  ...
  return (
    <div className="bg-blank-slate flex flex-col rounded-xl overflow-hidden transition-all duration-300 hover:shadow-xl border border-gray-200 shadow-md">
      <div className="p-6 flex flex-col flex-1">
        <h4 className="text-3xl font-bold text-focus-black mb-4 font-darker">Day Pass</h4>
        
        <div className="mb-6">
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-bold text-focus-black line-through font-darker">₹749</span>
            <span className="text-[2.75rem] font-bold text-focus-black font-darker">₹499</span>
        ...
        <ul className="space-y-4 mb-8 flex-1">
          <li className="flex items-start">
            ...
            <span className="text-focus-black font-semibold text-[1.05rem] lg:text-xl">8 hours of access</span>
          </li>
          <li className="flex items-start">
            <Check className="h-5 w-5 text-legacy-green mr-3 flex-shrink-0 mt-0.5" />
        ...
        <a 
          ...
          onClick={(e) => {
            ...
            if (contactForm && planSelect) {
              ...
              const optionToSelect = options.find(option => option.text === 'Day Pass');
              if (optionToSelect) {
